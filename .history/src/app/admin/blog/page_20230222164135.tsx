...
import {Folder: FolderIcon, CreateNewFolderOutlined} from "@mui/icons-material";
  ...
  return (
    <Container className="flex">
      <aside className="w-1/12 px-2 py-4">
        ...
        >
          <div className="px-4">
            <div className="py-3"><CreateNewFolderOutlined color="primary"/>Add new folder</div>
            <div className="py-3">Upload files</div>
          </div>
        </Popover>
      </aside>
